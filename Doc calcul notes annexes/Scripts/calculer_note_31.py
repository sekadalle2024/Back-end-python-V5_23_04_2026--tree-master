...
"""
Script de calcul de la NOTE 31 - SUBVENTIONS D'EXPLOITATION
Syscohada Révisé

Ce script calcule la Note 31 à partir des balances N, N-1, N-2 en utilisant
...
de l'exercice pour les subventions d'exploitation reçues par l'entreprise.
...
class CalculateurNote31(CalculateurNote):
    """
    Calculateur pour la Note 31 - Subventions d'Exploitation.
    
    Cette classe hérite de CalculateurNote et implémente le calcul spécifique
    de la Note 31 avec les subventions d'exploitation.
    ...
    - Subventions d'exploitation (exercice N)
    - Subventions d'exploitation (exercice N-1)
    - Variation N / N-1
    """
    
    def __init__(self, fichier_balance: str):
        """
        Initialise le calculateur de la Note 31.
        
        Args:
            fichier_balance: Chemin vers le fichier Excel des balances
        """
        super().__init__(fichier_balance, "31", "SUBVENTIONS D'EXPLOITATION")
        
        # Mapping des comptes pour la Note 31
        # Note: Pour les comptes de subventions d'exploitation, on utilise les comptes 71X
        self.mapping_comptes = {
            "Subventions d'équilibre": {
                'comptes': ['711', '7111', '7112', '7113', '7114', '7115', '7116', '7117', '7118', '7119']
            },
            'Subventions de fonctionnement': {
                'comptes': ['712', '7121', '7122', '7123', '7124', '7125', '7126', '7127', '7128', '7129']
            },
            'Subventions de prix': {
                'comptes': ['713', '7131', '7132', '7133', '7134', '7135', '7136', '7137', '7138', '7139']
            },
            "Autres subventions d'exploitation": {
                'comptes': ['718', '7181', '7182', '7183', '7184', '7185', '7186', '7187', '7188', '7189']
            }
        }
    ...
    def calculer_ligne_produit(
        ...
        Pour les comptes de subventions d'exploitation (classe 71), on extrait:
        ...
        # Pour les comptes de subventions d'exploitation (classe 71):
        # - Le solde créditeur représente les subventions reçues de l'exercice
        # - Les mouvements créditeurs sont les subventions enregistrées
    ...
    def generer_note(self) -> pd.DataFrame:
        """
        Génère la Note 31 complète avec les subventions d'exploitation N et N-1.
        
        Cette méthode:
        1. Calcule les subventions d'exploitation pour l'exercice N
        2. Calcule les subventions d'exploitation pour l'exercice N-1
        ...
        # Calculer pour chaque type de subvention d'exploitation
    ...
    def generer_html(self, df: pd.DataFrame) -> str:
        ...
        aux notes de subventions d'exploitation (pas d'amortissements).
        ...
        colonnes_config = {
            'groupes': [
                {'titre': "SUBVENTIONS D'EXPLOITATION", 'colonnes': ['montant', 'mouvements_credit', 'mouvements_debit']}
            ],
            'en_tetes': {
                'libelle': 'EXERCICE',
                'montant': 'Montant',
    ...
    def afficher_resume(self, df: pd.DataFrame):
        ...
        if len(total_rows) >= 2:
            ...
            print(f"  Subventions d'Exploitation Exercice N:    {montant_n:>15,.0f}")
            print(f"  Subventions d'Exploitation Exercice N-1:  {montant_n1:>15,.0f}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Calcul de la Note 31 - Subventions d'Exploitation"
    )
    parser.add_argument(
        'fichier_balance',
        nargs='?',
    ...
    parser.add_argument(
        '--output-html',
        default='../Tests/test_note_31.html',
        help='Chemin du fichier HTML de sortie (défaut: ../Tests/test_note_31.html)'
    )
    parser.add_argument(
        '--output-trace',
        default='../Tests/note_31_trace.json',
        help='Chemin du fichier de trace JSON (défaut: ../Tests/note_31_trace.json)'
    )
    
    args = parser.parse_args()
    
    # Créer le calculateur
    calculateur = CalculateurNote31(args.fichier_balance)
